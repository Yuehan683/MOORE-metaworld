...
python run_metaworld_sac_mt_hh.py \
  --seed ${SEED} \
  --n_exp 1 \
  --exp_type MT50 \
  --exp_name mhsac_moore_hh_400x3lx${N_EXPERTS}e \
  --results_dir logs \
  --batch_size 128 \
  --n_epochs 20 \
  --n_steps 100000 \
  ...
  --log_std_min -10 \
  --log_std_max 2 \
  --actor_network MetaworldSACMixtureMHActorNetworkHH \
  --critic_network MetaworldSACMixtureMHCriticNetworkHH \
  --orthogonal \
  --n_experts ${N_EXPERTS} \
  --activation Linear \
