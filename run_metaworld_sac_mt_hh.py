...
import moore.utils.networks_sac_hh as Network
...
def run_experiment(args, save_dir, exp_id=0, seed=None):
    ...
    if args.wandb:
        wandb.init(
            ...
            project="MOORE",
            group=f"metaworld_{args.env_name}" if args.env_name is not None else f"metaworld_{args.exp_type}",
...
if __name__ == '__main__':
    ...
    #alg_name = "mixture_orthogonal_experts_hh" if args.orthogonal else "mixture_experts_hh"
